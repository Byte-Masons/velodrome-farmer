...
async function main() {
  ...
  const gauge = '0x1032950b49fc23316655e5d0cc066bcd85b28ec7';

  const Strategy = await ethers.getContractFactory('contracts/ReaperStrategyVelodromeStable.sol:ReaperStrategyVelodrome');
