...
async function main() {
  ...
  const gauge = '0xAEA343b1EF5ECfa0D252d7078425BaC047cf5d18';

  const Strategy = await ethers.getContractFactory('ReaperStrategyVelodromeUsdcStable');
  ...
  //const strategist4 = '0xfffffffffffffffffffffffffffffffffffffff';
